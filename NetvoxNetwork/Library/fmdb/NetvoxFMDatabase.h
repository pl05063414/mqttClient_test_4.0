...
@interface NetvoxFMDatabase : NSObject  {
...
- (NetvoxFMResultSet *)executeQueryWithFormat:(NSString*)format, ... NS_FORMAT_FUNCTION(1,2);
...
@interface NetvoxFMStatement : NSObject {
