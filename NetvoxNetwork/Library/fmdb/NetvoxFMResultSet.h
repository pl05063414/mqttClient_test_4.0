...
@interface NetvoxFMResultSet : NSObject {
    NetvoxFMDatabase          *_parentDB;
    NetvoxFMStatement         *_statement;
...
@property (atomic, retain) NetvoxFMStatement *statement;
...
+ (instancetype)resultSetWithStatement:(NetvoxFMStatement *)statement usingParentDatabase:(NetvoxFMDatabase*)aDB;

/** Close result set */

- (void)close;

- (void)setParentDB:(NetvoxFMDatabase *)newDb;
