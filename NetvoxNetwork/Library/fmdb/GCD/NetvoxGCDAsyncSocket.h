...
@class NetvoxGCDAsyncReadPacket;
@class NetvoxGCDAsyncWritePacket;
@class NetvoxGCDAsyncSocketPreBuffer;

extern NSString *const NetvoxGCDAsyncSocketException;
extern NSString *const NetvoxGCDAsyncSocketErrorDomain;

extern NSString *const NetvoxGCDAsyncSocketQueueName;
extern NSString *const NetvoxGCDAsyncSocketThreadName;

extern NSString *const NetvoxGCDAsyncSocketManuallyEvaluateTrust;
#if TARGET_OS_IPHONE
extern NSString *const NetvoxGCDAsyncSocketUseCFStreamForTLS;
#endif
#define NetvoxGCDAsyncSocketSSLPeerName     (NSString *)kCFStreamSSLPeerName
#define NetvoxGCDAsyncSocketSSLCertificates (NSString *)kCFStreamSSLCertificates
#define NetvoxGCDAsyncSocketSSLIsServer     (NSString *)kCFStreamSSLIsServer
extern NSString *const NetvoxGCDAsyncSocketSSLPeerID;
extern NSString *const NetvoxGCDAsyncSocketSSLProtocolVersionMin;
extern NSString *const NetvoxGCDAsyncSocketSSLProtocolVersionMax;
extern NSString *const NetvoxGCDAsyncSocketSSLSessionOptionFalseStart;
extern NSString *const NetvoxGCDAsyncSocketSSLSessionOptionSendOneByteRecord;
extern NSString *const NetvoxGCDAsyncSocketSSLCipherSuites;
#if !TARGET_OS_IPHONE
extern NSString *const NetvoxGCDAsyncSocketSSLDiffieHellmanParameters;
#endif

#define NetvoxGCDAsyncSocketLoggingContext 65535


typedef NS_ENUM(NSInteger, NetvoxGCDAsyncSocketError) {
	NetvoxGCDAsyncSocketNoError = 0,           // Never used
	NetvoxGCDAsyncSocketBadConfigError,        // Invalid configuration
	NetvoxGCDAsyncSocketBadParamError,         // Invalid parameter was passed
	NetvoxGCDAsyncSocketConnectTimeoutError,   // A connect operation timed out
	NetvoxGCDAsyncSocketReadTimeoutError,      // A read operation timed out
	NetvoxGCDAsyncSocketWriteTimeoutError,     // A write operation timed out
	NetvoxGCDAsyncSocketReadMaxedOutError,     // Reached set maxLength without completing
	NetvoxGCDAsyncSocketClosedError,           // The remote peer closed the connection
	NetvoxGCDAsyncSocketOtherError,            // Description provided in userInfo
};
...
@interface NetvoxGCDAsyncSocket : NSObject
...
@protocol NetvoxGCDAsyncSocketDelegate
@optional
...
**/
- (dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(NetvoxGCDAsyncSocket *)sock;
...
**/
- (void)socket:(NetvoxGCDAsyncSocket *)sock didAcceptNewSocket:(NetvoxGCDAsyncSocket *)newSocket;
 ...
 * The host parameter will be an IP address, not a DNS name.
 **/
- (void)socket:(NetvoxGCDAsyncSocket *)sock didConnectToUrl:(NSURL *)url;
...
**/
- (void)socket:(NetvoxGCDAsyncSocket *)sock didReadPartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
 ...
 * It may be used to for things such as updating progress bars.
**/
- (void)socket:(NetvoxGCDAsyncSocket *)sock didWritePartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
...
**/
- (NSTimeInterval)socket:(NetvoxGCDAsyncSocket *)sock shouldTimeoutReadWithTag:(long)tag
...
**/
- (NSTimeInterval)socket:(NetvoxGCDAsyncSocket *)sock shouldTimeoutWriteWithTag:(long)tag
                                                                  elapsed:(NSTimeInterval)elapsed
                                                                bytesDone:(NSUInteger)length;
...
**/
- (void)socketDidCloseReadStream:(NetvoxGCDAsyncSocket *)sock;
...
**/
- (void)socketDidSecure:(NetvoxGCDAsyncSocket *)sock;
...
**/
- (void)socket:(NetvoxGCDAsyncSocket *)sock didReceiveTrust:(SecTrustRef)trust
