...
extern NSString *const NetvoxGCDAsyncUdpSocketException;
extern NSString *const NetvoxGCDAsyncUdpSocketErrorDomain;

extern NSString *const NetvoxGCDAsyncUdpSocketQueueName;
extern NSString *const NetvoxGCDAsyncUdpSocketThreadName;

typedef NS_ENUM(NSInteger, NetvoxGCDAsyncUdpSocketError) {
	NetvoxGCDAsyncUdpSocketNoError = 0,          // Never used
	NetvoxGCDAsyncUdpSocketBadConfigError,       // Invalid configuration
	NetvoxGCDAsyncUdpSocketBadParamError,        // Invalid parameter was passed
	NetvoxGCDAsyncUdpSocketSendTimeoutError,     // A send operation timed out
	NetvoxGCDAsyncUdpSocketClosedError,          // The socket was closed
	NetvoxGCDAsyncUdpSocketOtherError,           // Description provided in userInfo
};
...
@class NetvoxGCDAsyncUdpSocket;

@protocol NetvoxGCDAsyncUdpSocketDelegate
@optional
...
**/
- (void)udpSocket:(NetvoxGCDAsyncUdpSocket *)sock didConnectToAddress:(NSData *)address;
...
**/
- (void)udpSocket:(NetvoxGCDAsyncUdpSocket *)sock didNotConnect:(NSError *)error;

/**
 * Called when the datagram with the given tag has been sent.
**/
- (void)udpSocket:(NetvoxGCDAsyncUdpSocket *)sock didSendDataWithTag:(long)tag;

/**
 * Called if an error occurs while trying to send a datagram.
 * This could be due to a timeout, or something more serious such as the data being too large to fit in a sigle packet.
**/
- (void)udpSocket:(NetvoxGCDAsyncUdpSocket *)sock didNotSendDataWithTag:(long)tag dueToError:(NSError *)error;

/**
 * Called when the socket has received the requested datagram.
**/
- (void)udpSocket:(NetvoxGCDAsyncUdpSocket *)sock didReceiveData:(NSData *)data
...
**/
- (void)udpSocketDidClose:(NetvoxGCDAsyncUdpSocket *)sock withError:(NSError *)error;
...
@interface NetvoxGCDAsyncUdpSocket : NSObject
...
- (id <NetvoxGCDAsyncUdpSocketDelegate>)delegate;
- (void)setDelegate:(id <NetvoxGCDAsyncUdpSocketDelegate>)delegate;
- (void)synchronouslySetDelegate:(id <NetvoxGCDAsyncUdpSocketDelegate>)delegate;
...
- (void)setDelegate:(id <NetvoxGCDAsyncUdpSocketDelegate>)delegate delegateQueue:(dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(id <NetvoxGCDAsyncUdpSocketDelegate>)delegate delegateQueue:(dispatch_queue_t)delegateQueue;
