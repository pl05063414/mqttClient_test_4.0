...
#import "NetvoxGCDAsyncUdpSocket.h"
...
@class NetvoxGCDAsyncUdpSendPacket;

NSString *const NetvoxGCDAsyncUdpSocketException = @"GCDAsyncUdpSocketException";
NSString *const NetvoxGCDAsyncUdpSocketErrorDomain = @"GCDAsyncUdpSocketErrorDomain";

NSString *const NetvoxGCDAsyncUdpSocketQueueName = @"GCDAsyncUdpSocket";
NSString *const NetvoxGCDAsyncUdpSocketThreadName = @"GCDAsyncUdpSocket-CFStream";

enum NetvoxGCDAsyncUdpSocketFlags
{
...
enum NetvoxGCDAsyncUdpSocketConfig
{
...
@interface NetvoxGCDAsyncUdpSocket ()
{
	...
	NetvoxGCDAsyncUdpSendPacket *currentSend;
...
**/
@interface NetvoxGCDAsyncUdpSendPacket : NSObject {
@public
	NSData *buffer;
...
@implementation NetvoxGCDAsyncUdpSendPacket
...
@interface NetvoxGCDAsyncUdpSpecialPacket : NSObject {
@public
//	uint8_t type;
...
@implementation NetvoxGCDAsyncUdpSpecialPacket
...
@implementation NetvoxGCDAsyncUdpSocket
...
- (id)initWithDelegate:(id <NetvoxGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(dispatch_queue_t)dq
{
	LogTrace();
...
- (id)initWithDelegate:(id <NetvoxGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(dispatch_queue_t)dq socketQueue:(dispatch_queue_t)sq
{
	LogTrace();
	...
	if ((self = [super init]))
	{
		...
		{
			socketQueue = dispatch_queue_create([NetvoxGCDAsyncUdpSocketQueueName UTF8String], NULL);
		}
...
- (void)setDelegate:(id <NetvoxGCDAsyncUdpSocketDelegate>)newDelegate synchronously:(BOOL)synchronously
{
...
- (void)setDelegate:(id <NetvoxGCDAsyncUdpSocketDelegate>)newDelegate
{
	[self setDelegate:newDelegate synchronously:NO];
}

- (void)synchronouslySetDelegate:(id <NetvoxGCDAsyncUdpSocketDelegate>)newDelegate
{
...
- (void)getDelegate:(id <NetvoxGCDAsyncUdpSocketDelegate> *)delegatePtr delegateQueue:(dispatch_queue_t *)delegateQueuePtr
{
	if (dispatch_get_specific(IsOnSocketQueueOrTargetQueueKey))
	{
...
- (void)setDelegate:(id <NetvoxGCDAsyncUdpSocketDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue synchronously:(BOOL)synchronously
{
	dispatch_block_t block = ^{
...
- (void)setDelegate:(id <NetvoxGCDAsyncUdpSocketDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue
{
	[self setDelegate:newDelegate delegateQueue:newDelegateQueue synchronously:NO];
}

- (void)synchronouslySetDelegate:(id <NetvoxGCDAsyncUdpSocketDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue
{
...
- (NSError *)badConfigError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:NetvoxGCDAsyncUdpSocketErrorDomain
	                           code:NetvoxGCDAsyncUdpSocketBadConfigError
	                       userInfo:userInfo];
}
...
- (NSError *)badParamError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:NetvoxGCDAsyncUdpSocketErrorDomain
	                           code:NetvoxGCDAsyncUdpSocketBadParamError
	                       userInfo:userInfo];
}
...
- (NSError *)sendTimeoutError
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"GCDAsyncUdpSocketSendTimeoutError",
	                                                     @"NetvoxGCDAsyncUdpSocket", [NSBundle mainBundle],
	                                                     @"Send operation timed out", nil);
	
	NSDictionary *userInfo = [NSDictionary dictionaryWithObject:errMsg forKey:NSLocalizedDescriptionKey];
	
	return [NSError errorWithDomain:NetvoxGCDAsyncUdpSocketErrorDomain
	                           code:NetvoxGCDAsyncUdpSocketSendTimeoutError
	                       userInfo:userInfo];
}
...
- (NSError *)socketClosedError
{
	...
	return [NSError errorWithDomain:NetvoxGCDAsyncUdpSocketErrorDomain code:NetvoxGCDAsyncUdpSocketClosedError userInfo:userInfo];
}
...
- (NSError *)otherError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:NetvoxGCDAsyncUdpSocketErrorDomain
	                           code:NetvoxGCDAsyncUdpSocketOtherError
	                       userInfo:userInfo];
}
...
- (BOOL)connectToHost:(NSString *)host onPort:(uint16_t)port error:(NSError **)errPtr
{
	...
	dispatch_block_t block = ^{ @autoreleasepool {
		...
		NetvoxGCDAsyncUdpSpecialPacket *packet = [[NetvoxGCDAsyncUdpSpecialPacket alloc] init];
...
- (void)maybeConnect
{
	...
	BOOL sendQueueReady = [currentSend isKindOfClass:[NetvoxGCDAsyncUdpSpecialPacket class]];
	
	if (sendQueueReady)
	{
		NetvoxGCDAsyncUdpSpecialPacket *connectPacket = (NetvoxGCDAsyncUdpSpecialPacket *)currentSend;
...
- (void)sendData:(NSData *)data withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
	...
	NetvoxGCDAsyncUdpSendPacket *packet = [[NetvoxGCDAsyncUdpSendPacket alloc] initWithData:data timeout:timeout tag:tag];
...
- (void)sendData:(NSData *)data toAddress:(NSData *)remoteAddr withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
	...
	NetvoxGCDAsyncUdpSendPacket *packet = [[NetvoxGCDAsyncUdpSendPacket alloc] initWithData:data timeout:timeout tag:tag];
	packet->addressFamily = [NetvoxGCDAsyncUdpSocket familyFromAddress:remoteAddr];
...
- (void)maybeDequeueSend
{
	...
	if (currentSend == nil)
	{
		...
		while ([sendQueue count] > 0)
		{
			...
			if ([currentSend isKindOfClass:[NetvoxGCDAsyncUdpSpecialPacket class]])
			{
				[self maybeConnect];
...
- (void)doPreSend
{
	...
	if (sendFilterBlock && sendFilterQueue)
	{
		...
		if (sendFilterAsync)
		{
			...
			NetvoxGCDAsyncUdpSendPacket *sendPacket = currentSend;
...
+ (void)listenerThread
{
	@autoreleasepool {
		...
		[[NSThread currentThread] setName:NetvoxGCDAsyncUdpSocketThreadName];
...
+ (void)addStreamListener:(NetvoxGCDAsyncUdpSocket *)asyncUdpSocket
{
	LogTrace();
...
+ (void)removeStreamListener:(NetvoxGCDAsyncUdpSocket *)asyncUdpSocket
{
	LogTrace();
	NSAssert([NSThread currentThread] == listenerThread, @"Invoked on wrong thread");
...
{
	@autoreleasepool {
		NetvoxGCDAsyncUdpSocket *asyncUdpSocket = (__bridge NetvoxGCDAsyncUdpSocket *)pInfo;
