...
NSString *const NetvoxGCDAsyncSocketException = @"NetvoxGCDAsyncSocketException";
NSString *const NetvoxGCDAsyncSocketErrorDomain = @"NetvoxGCDAsyncSocketErrorDomain";

NSString *const NetvoxGCDAsyncSocketQueueName = @"NetvoxGCDAsyncSocket";
NSString *const NetvoxGCDAsyncSocketThreadName = @"NetvoxGCDAsyncSocket-CFStream";

NSString *const NetvoxGCDAsyncSocketManuallyEvaluateTrust = @"NetvoxGCDAsyncSocketManuallyEvaluateTrust";
#if TARGET_OS_IPHONE
NSString *const NetvoxGCDAsyncSocketUseCFStreamForTLS = @"NetvoxGCDAsyncSocketUseCFStreamForTLS";
#endif
NSString *const NetvoxGCDAsyncSocketSSLPeerID = @"NetvoxGCDAsyncSocketSSLPeerID";
NSString *const NetvoxGCDAsyncSocketSSLProtocolVersionMin = @"NetvoxGCDAsyncSocketSSLProtocolVersionMin";
NSString *const NetvoxGCDAsyncSocketSSLProtocolVersionMax = @"NetvoxGCDAsyncSocketSSLProtocolVersionMax";
NSString *const NetvoxGCDAsyncSocketSSLSessionOptionFalseStart = @"NetvoxGCDAsyncSocketSSLSessionOptionFalseStart";
NSString *const NetvoxGCDAsyncSocketSSLSessionOptionSendOneByteRecord = @"NetvoxGCDAsyncSocketSSLSessionOptionSendOneByteRecord";
NSString *const NetvoxGCDAsyncSocketSSLCipherSuites = @"NetvoxGCDAsyncSocketSSLCipherSuites";
#if !TARGET_OS_IPHONE
NSString *const NetvoxGCDAsyncSocketSSLDiffieHellmanParameters = @"NetvoxGCDAsyncSocketSSLDiffieHellmanParameters";
#endif

enum NetvoxGCDAsyncSocketFlags
{
...
enum NetvoxGCDAsyncSocketConfig
{
...
@interface NetvoxGCDAsyncSocketPreBuffer : NSObject
{
	uint8_t *preBuffer;
...
@implementation NetvoxGCDAsyncSocketPreBuffer
...
**/
@interface NetvoxGCDAsyncReadPacket : NSObject
{
  @public
...
- (NSUInteger)readLengthForTermWithPreBuffer:(NetvoxGCDAsyncSocketPreBuffer *)preBuffer found:(BOOL *)foundPtr;

- (NSInteger)searchForTermAfterPreBuffering:(ssize_t)numBytes;

@end

@implementation NetvoxGCDAsyncReadPacket
...
**/
@interface NetvoxGCDAsyncWritePacket : NSObject
{
  @public
	NSData *buffer;
	NSUInteger bytesDone;
...
@implementation NetvoxGCDAsyncWritePacket
...
**/
@interface NetvoxGCDAsyncSpecialPacket : NSObject
{
  @public
...
@implementation NetvoxGCDAsyncSpecialPacket
...
@implementation NetvoxGCDAsyncSocket
{
	uint32_t flags;
	uint16_t config;
	...
	NetvoxGCDAsyncReadPacket *currentRead;
	NetvoxGCDAsyncWritePacket *currentWrite;
	
	unsigned long socketFDBytesAvailable;
	
	NetvoxGCDAsyncSocketPreBuffer *preBuffer;
	...
	NetvoxGCDAsyncSocketPreBuffer *sslPreBuffer;
...
- (id)initWithDelegate:(id)aDelegate delegateQueue:(dispatch_queue_t)dq socketQueue:(dispatch_queue_t)sq
{
	if((self = [super init]))
	{
		...
		{
			socketQueue = dispatch_queue_create([NetvoxGCDAsyncSocketQueueName UTF8String], NULL);
		}
		...
		preBuffer = [[NetvoxGCDAsyncSocketPreBuffer alloc] initWithCapacity:(1024 * 4)];
	}
	return self;
}
...
- (BOOL)acceptOnInterface:(NSString *)inInterface port:(uint16_t)port error:(NSError **)errPtr
{
	...
	dispatch_block_t block = ^{ @autoreleasepool {
		...
		if (enableIPv4)
		{
			...
			__weak NetvoxGCDAsyncSocket *weakSelf = self;
			
			dispatch_source_set_event_handler(accept4Source, ^{ @autoreleasepool {
			#pragma clang diagnostic push
			#pragma clang diagnostic warning "-Wimplicit-retain-self"
				
				__strong NetvoxGCDAsyncSocket *strongSelf = weakSelf;
...
- (BOOL)doAccept:(int)parentSocketFD
{
	...
	if (delegateQueue)
	{
		...
		dispatch_async(delegateQueue, ^{ @autoreleasepool {
			...
			NetvoxGCDAsyncSocket *acceptedSocket = [[[self class] alloc] initWithDelegate:theDelegate
...
- (NSError *)badConfigError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:NetvoxGCDAsyncSocketErrorDomain code:NetvoxGCDAsyncSocketBadConfigError userInfo:userInfo];
}
...
- (NSError *)badParamError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:NetvoxGCDAsyncSocketErrorDomain code:NetvoxGCDAsyncSocketBadParamError userInfo:userInfo];
}
...
- (NSError *)connectTimeoutError
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"GCDAsyncSocketConnectTimeoutError",
	                                                     @"NetvoxGCDAsyncSocket", [NSBundle mainBundle],
	                                                     @"Attempt to connect to host timed out", nil);
	
	NSDictionary *userInfo = [NSDictionary dictionaryWithObject:errMsg forKey:NSLocalizedDescriptionKey];
	
	return [NSError errorWithDomain:NetvoxGCDAsyncSocketErrorDomain code:NetvoxGCDAsyncSocketConnectTimeoutError userInfo:userInfo];
}
...
- (NSError *)readMaxedOutError
{
	...
	return [NSError errorWithDomain:NetvoxGCDAsyncSocketErrorDomain code:NetvoxGCDAsyncSocketReadMaxedOutError userInfo:info];
}
...
- (NSError *)readTimeoutError
{
	...
	return [NSError errorWithDomain:NetvoxGCDAsyncSocketErrorDomain code:NetvoxGCDAsyncSocketReadTimeoutError userInfo:userInfo];
}
...
- (NSError *)writeTimeoutError
{
	...
	return [NSError errorWithDomain:NetvoxGCDAsyncSocketErrorDomain code:NetvoxGCDAsyncSocketWriteTimeoutError userInfo:userInfo];
}
...
- (NSError *)connectionClosedError
{
	...
	return [NSError errorWithDomain:NetvoxGCDAsyncSocketErrorDomain code:NetvoxGCDAsyncSocketClosedError userInfo:userInfo];
}
...
- (NSError *)otherError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:NetvoxGCDAsyncSocketErrorDomain code:NetvoxGCDAsyncSocketOtherError userInfo:userInfo];
}
                        ...
                        tag:(long)tag
{
	...
	NetvoxGCDAsyncReadPacket *packet = [[NetvoxGCDAsyncReadPacket alloc] initWithData:buffer
	                                                          startOffset:offset
	                                                            maxLength:length
	                                                              timeout:timeout
	                                                           readLength:0
...
- (float)progressOfReadReturningTag:(long *)tagPtr bytesDone:(NSUInteger *)donePtr total:(NSUInteger *)totalPtr
{
	...
	dispatch_block_t block = ^{
		...
		if (!currentRead || ![currentRead isKindOfClass:[NetvoxGCDAsyncReadPacket class]])
		{
...
- (void)maybeDequeueRead
{
	...
	if ((currentRead == nil) && (flags & kConnected))
	{
		if ([readQueue count] > 0)
		{
			...
			if ([currentRead isKindOfClass:[NetvoxGCDAsyncSpecialPacket class]])
			{
...
- (void)completeCurrentRead
{
	...
	{
		NetvoxGCDAsyncReadPacket *theRead = currentRead; // Ensure currentRead retained since result may not own buffer
...
- (void)doReadTimeout
{
	...
	{
		NetvoxGCDAsyncReadPacket *theRead = currentRead;
...
- (void)writeData:(NSData *)data withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
	...
	NetvoxGCDAsyncWritePacket *packet = [[NetvoxGCDAsyncWritePacket alloc] initWithData:data timeout:timeout tag:tag];
...
- (float)progressOfWriteReturningTag:(long *)tagPtr bytesDone:(NSUInteger *)donePtr total:(NSUInteger *)totalPtr
{
	...
	dispatch_block_t block = ^{
		...
		if (!currentWrite || ![currentWrite isKindOfClass:[NetvoxGCDAsyncWritePacket class]])
		{
...
- (void)maybeDequeueWrite
{
	...
	if ((currentWrite == nil) && (flags & kConnected))
	{
		if ([writeQueue count] > 0)
		{
			...
			if ([currentWrite isKindOfClass:[NetvoxGCDAsyncSpecialPacket class]])
			{
				LogVerbose(@"Dequeued GCDAsyncSpecialPacket");
...
- (void)doWriteTimeout
{
	...
	{
		NetvoxGCDAsyncWritePacket *theWrite = currentWrite;
...
- (void)startTLS:(NSDictionary *)tlsSettings
{
	...
	NetvoxGCDAsyncSpecialPacket *packet = [[NetvoxGCDAsyncSpecialPacket alloc] initWithTLSSettings:tlsSettings];
...
- (void)maybeStartTLS
{
	...
	if ((flags & kStartingReadTLS) && (flags & kStartingWriteTLS))
	{
		...
		#if TARGET_OS_IPHONE
		{
			NetvoxGCDAsyncSpecialPacket *tlsPacket = (NetvoxGCDAsyncSpecialPacket *)currentRead;
			NSDictionary *tlsSettings = tlsPacket->tlsSettings;
			
			NSNumber *value = [tlsSettings objectForKey:NetvoxGCDAsyncSocketUseCFStreamForTLS];
...
{
	NetvoxGCDAsyncSocket *asyncSocket = (__bridge NetvoxGCDAsyncSocket *)connection;
...
- (void)ssl_startTLS
{
	...
	BOOL shouldManuallyEvaluateTrust = [[tlsSettings objectForKey:NetvoxGCDAsyncSocketManuallyEvaluateTrust] boolValue];
	...
	value = [tlsSettings objectForKey:NetvoxGCDAsyncSocketSSLPeerID];
	...
	value = [tlsSettings objectForKey:NetvoxGCDAsyncSocketSSLProtocolVersionMin];
	...
	value = [tlsSettings objectForKey:NetvoxGCDAsyncSocketSSLProtocolVersionMax];
	if ([value isKindOfClass:[NSNumber class]])
	{
	...
	{
		NSAssert(NO, @"Invalid value for NetvoxGCDAsyncSocketSSLProtocolVersionMax. Value must be of type NSNumber.");
		
		[self closeWithError:[self otherError:@"Invalid value for NetvoxGCDAsyncSocketSSLProtocolVersionMax."]];
		return;
	}
	
	// 6. GCDAsyncSocketSSLSessionOptionFalseStart
	
	value = [tlsSettings objectForKey:NetvoxGCDAsyncSocketSSLSessionOptionFalseStart];
	if ([value isKindOfClass:[NSNumber class]])
	{
	...
	value = [tlsSettings objectForKey:NetvoxGCDAsyncSocketSSLSessionOptionSendOneByteRecord];
	if ([value isKindOfClass:[NSNumber class]])
	{
	...
	value = [tlsSettings objectForKey:NetvoxGCDAsyncSocketSSLCipherSuites];
	if ([value isKindOfClass:[NSArray class]])
	{
	...
	if (value)
	{
		NSAssert(NO, @"Security option unavailable - kCFStreamSSLLevel"
		             @" - You must use NetvoxGCDAsyncSocketSSLProtocolVersionMin & NetvoxGCDAsyncSocketSSLProtocolVersionMax");
	...
	sslPreBuffer = [[NetvoxGCDAsyncSocketPreBuffer alloc] initWithCapacity:(1024 * 4)];
...
- (void)ssl_continueSSLHandshake
{
	...
	else if (status == errSSLPeerAuthCompleted)
	{
		...
		else
		{
			...
			NSString *msg = @"NetvoxGCDAsyncSocketManuallyEvaluateTrust specified in tlsSettings,"
...
- (void)cf_startTLS
{
	...
	NSAssert([currentRead isKindOfClass:[NetvoxGCDAsyncSpecialPacket class]], @"Invalid read packet for startTLS");
	NSAssert([currentWrite isKindOfClass:[NetvoxGCDAsyncSpecialPacket class]], @"Invalid write packet for startTLS");
...
{
	[[NSThread currentThread] setName:NetvoxGCDAsyncSocketThreadName];
...
+ (void)scheduleCFStreams:(NetvoxGCDAsyncSocket *)asyncSocket
{
	LogTrace();
...
+ (void)unscheduleCFStreams:(NetvoxGCDAsyncSocket *)asyncSocket
{
	LogTrace();
	NSAssert([NSThread currentThread] == cfstreamThread, @"Invoked on wrong thread");
...
{
	NetvoxGCDAsyncSocket *asyncSocket = (__bridge NetvoxGCDAsyncSocket *)pInfo;
