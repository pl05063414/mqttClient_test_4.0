...
@interface NetvoxFMDatabasePool()

- (void)pushDatabaseBackInPool:(NetvoxFMDatabase*)db;
- (NetvoxFMDatabase*)db;

@end


@implementation NetvoxFMDatabasePool
...
- (NetvoxFMDatabase*)db {
    ...
    [self executeLocked:^() {
        ...
        if (db) {
            ...
            db = [NetvoxFMDatabase databaseWithPath:self->_path];
