...
{	
	...
	else
	{
		...
		{
            if([elementName isEqualToString:@"Dests"] || [elementName isEqualToString:@"Rule"] || [elementName isEqualToString:@"Action"] || [elementName isEqualToString:@"Dest"] || [elementName isEqualToString:@"Device"] || [elementName isEqualToString:@"DeviceNode"] || ([elementName isEqualToString:@"Conditions"] && attributeDict.allKeys.count != 0)) {
                top[elementName] = [NSMutableArray arrayWithObject:node];
            }else{
